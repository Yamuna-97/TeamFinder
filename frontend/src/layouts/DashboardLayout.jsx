...
const DashboardLayout = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] bg-gray-50 overflow-hidden">
      {/* Sidebar */}
      <aside className={`${sidebarOpen ? 'block' : 'hidden'} md:block md:w-64 bg-white border-r border-gray-100 flex-shrink-0 flex flex-col h-full`}>
        <div className="p-5 flex flex-col flex-1 overflow-y-auto">
          {/* User Info Card */}
          {user && (
            <div className="mb-6 p-4 bg-[#eff6ff] border border-[#dbeafe] rounded-2xl flex flex-col">
          ...
          {/* EXTRAS section */}
          <div className="mt-8 mb-2.5 px-4 text-xs font-bold text-gray-400 tracking-wider uppercase">
            EXTRAS
          </div>
          ...
          <div className="mt-auto pt-6">
            <button
              ...
              className="w-full flex items-center px-4 py-2.5 rounded-xl text-red-600 hover:bg-red-50 transition-all duration-200 font-medium"
            >
      ...
      <div className="flex-1 overflow-auto flex flex-col h-full">
        {/* Mobile header */}
        <header className="md:hidden bg-white shadow-sm p-4 flex items-center justify-between flex-shrink-0">
          <button
