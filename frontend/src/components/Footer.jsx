    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">TeamFinder</h3>
            <p className="text-gray-400">
              Find the perfect teammates for your college projects. Connect with skilled students and build amazing projects together.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Email: support@teamfinder.com</li>
              <li>College Project Platform</li>
